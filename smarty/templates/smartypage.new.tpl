...
<body>
		...
		<div id="daikuan">
				...
				<div class="header-top">
					<div class='header-top-1'>
						...
						{else}
							...
							<!--<span class='span1-2 span1-5 hoverpointer'>Hi,{$showname|mb_substr:0:3:'GBK'}****{$showname|mb_substr:7:11:'GBK'}</span>-->
			...
			<div id='bodyer'>
				...
				<!--这是图片-->
				<div class='img2-3' style="overflow: hidden;">
					<img src="{$showpage.imgurl}" style="height:100%;"/>
				</div>
				<!--<div class='img2-3' style='background:url({$showpage.imgurl}) center top;'>
					<div class='img2-form'>
						<p>快速贷款通道</p>
				...
				<div class='div-table2'>
					<table class='table2-2' cellspacing="0" cellpadding="0">
						<tr class='div2-1'>
							<th class='span2-3 span2-2'>产品名称</th>
							<th class='span2-3 span2-2'>特点</th>
							<th class='span2-3 span2-2'>贷款额度</th>
							<th class='span2-3 span2-2'>还款方式</th>
						...
						<div class='footer-top-1'>
							...
							<div class='footer-top-tel'>
								<div class='footer-tel-left'>
									<img src='{$footerfixed.xodeimg}'>
									<p>信贷网微信公众账号</p>
								</div>
								<div class='footer-tel-right'>
									<span>有问题咨询请投递</span><br>
									<span class='footer-span'>{$footerfixed.email}</span>
								</div>
								<div class='footer-tel-right footer-tel-right-2'>
									<span>摇一摇微信号 </span><br>
									<span class='footer-span'>{$footerfixed.wxnum}</span>
								</div>
								<div class='footer-tel-right footer-tel-right-3'>
									<span>QQ随时在线</span><br>
									<span class='footer-span' id='qqnum' >{$footerfixed.qqnum}</span>
								</div>
							</div>
						</div>
					</div>
	...
	<script type="text/javascript">
		...
		function OnLoad(){
			...
			$("#qqnum").click(function(){
				window.location.href='http://wpa.qq.com/msgrd?v=3&uin=295596499&site=qq&menu=yes';
			});
