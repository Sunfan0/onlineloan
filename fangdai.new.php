...
?>
		<div class="contanier calotherdiv">
			...
			<div class="loaciton"><img src="images/location.png" alt="" />您当前的位置：
				...
				<a class="hoverpointer" onclick="SkipHref('fangdai')">贷款计算器</a> 
			</div>
							...
							<div class="input_fangdai">
									<table class='div1'>
										 ...
										 <tr class="div1_1h">
											...
											<td>
												<div class="input-group" style="margin: 0;">
													<input type="text" class="inpt" id="dkje_1"  aria-describedby="basic-addon2">
										...
										<tr class="div1_2">
											...
											<td>
												<div class="input-group" style="margin: 0;">
													<input type="text" class="inpt" id="pmdj_1"  aria-describedby="basic-addon3"/>
													<span class="input-group-addon" id="basic-addon3">元/平米</span>
												</div>
											</td>
										</tr>
										<tr class="div1_2">
											...
											<td>
												<div class="input-group" style="margin: 0;">
													<input type="text" class="inpt" id="mj_1"  aria-describedby="basic-addon4"/>
													<span class="input-group-addon" id="basic-addon4">平  　米</span>
												</div>
											</td>
										</tr>
										<tr class="div1_2">
	...
	<script>
		...
		//等额本息
			...
			$("#_debx_myhk").html(Round(money1));
			//每月还款_debx_myhk	
			totalint=money1 * monthtime - summoney;
			$("#_debx_zflx").html(Round(totalint));
			//总支付利息_debx_zflx
			//贷款额*贷款月数*月利率*（1+月利率）^贷款月数/[（1+月利率）^贷款月数-1]
			$("#_debx_hkze").html(Round(totalint+summoney));
			//本息合计_debx_hkze
		//等额本金
			$("#_debj_dkje").html(Round(summoney));
			//贷款总额_debj_dkje
			...
			$("#_debj_mydj").html(Round(money5));
			//每月递减：_debj_mydj
			//(还款月数+1)*贷款额*月利率/2
			totalint2=(monthtime+1)*summoney*(monthrate/2);
			$("#_debj_zflx").html(Round(totalint2));
			//总支付利息_debj_zflx
			//(还款月数+1)*贷款额*月利率/2+贷款额
			$("#_debj_hkze").html(Round(totalint2+summoney));
			//本息合计_debj_hkze
		}
	</script>
</html>