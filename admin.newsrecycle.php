	...
	<script type="text/javascript">
		...
		function ShowNewsList(){
			GotListTable = $('#ContentTable').DataTable({
				"ajax": {
					"url":"admin.newsrecycle.ajax.php?mode=ShownewsList",
					"type":"POST"
				},
...
console.log(json);
		...
		function ShowNewsInfo(id){
			Settings.Flagid = id;
			url = "admin.newsrecycle.ajax.php?mode=Shownewsdetail&id="+id;
		...
		function NewsRecover(batch){
			...
			$.confirm({
				...
				confirm: function(){
					switch(batch){
						case 0:
							url = "admin.newsrecycle.ajax.php?mode=NewsRecover&id="+Settings.Flagid;
							$.get(url,function(json,status){
console.log(json);
								switch (json){
									case "1":
...
console.log(data);
							url = "admin.newsrecycle.ajax.php?mode=MoreNewsRecover";
							$.get(url,{
