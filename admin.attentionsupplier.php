			  ...
			  <div class="modal-dialog" style="width:900px;">
				<div class="modal-content message_align">
				  ...
				  <div class="modal-body">
					 <table id="ShowUserInfo" class="table table-hover table-bordered" style="width:100%;">
						<thead>
							<tr>
								<th>用户名</th>
								<th>手机号码</th>
	...
	<script type="text/javascript">
		...
		function ShowSupplierList(){
			GotListTable = $('#ContentTable').DataTable({
				"ajax": {
					"url":"admin.attentionsupplier.ajax.php?mode=ShowSupplierList",
					"type":"POST"
				},
		...
		function ShowUserInfo(id){
			...
			GotInfoTable = $('#ShowUserInfo').DataTable({
				"ajax": {
					"url":"admin.attentionsupplier.ajax.php?mode=ShowDemanderList&supplierid="+id,
					"type":"POST"
				},
				//"processing": true,//加载效果
				"serverSide": true,//页面在加载时就请求后台，以及每次对 datatable 进行操作时也是请求后台
