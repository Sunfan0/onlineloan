			  ...
			  <div class="modal-dialog" style="width:1100px;">  
				<div class="modal-content message_align">  
				  <div class="modal-header">  
					...
					<h5 class="modal-title">供方信息详情</h5>  
				  </div>  
				  <div class="modal-body text-center"> 
						<form class="form-horizontal">
							...
							<div class="form-group">
								<label for="GoodsRegisttime" class="col-sm-2 control-label">注册时间</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" id="GoodsRegisttime" disabled>
								</div>
							</div>
							<div class="form-group">
								<label for="GoodsIsallowed" class="col-sm-2 control-label">审核结果</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" id="GoodsIsallowed" disabled>
								</div>
							</div>
							<div class="form-group">
								<label for="GoodsOperator" class="col-sm-2 control-label">审核人员</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" id="GoodsOperator" disabled>
								</div>
							</div>
							<div class="form-group">
								<label for="GoodsOperattime" class="col-sm-2 control-label">审核时间</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" id="GoodsOperattime" disabled>
								</div>
							</div>
						</form>
				  </div>   
	...
	<script type="text/javascript">
		...
		function ShowCheckList(){
			GotListTable = $('#CheckResultList').DataTable({
				"ajax": {
					"url":"admin.checksupplyinfohistory.ajax.php?mode=ShowSupplyinfoList",
					"type":"POST"
				},
		...
		function ShowDetailInfo(id){//显示详细信息
			...
			url = "admin.checksupplyinfohistory.ajax.php?mode=ShowSupplyinfoDetail&id="+id;
...
console.log(json);
				...
				$("#GoodsRegisttime").val(json.createtime);
				$("#GoodsIsallowed").val(isallowed);
				$("#GoodsOperator").val(json.operator);
				$("#GoodsOperattime").val(json.operattime);
			});
		}
