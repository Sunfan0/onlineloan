<?php
	...
	switch($mode){
		case "ShowList":
			...
			$strSql.= " where s1.receivertype=1 and s1.receiverid=$supplierid ";
			$search = Get("search");
			$toLike = $search["value"];
			...
			$strSqlCountAll = "Select count(*) FROM websitenoticehistory  where receivertype=1 and receiverid=$supplierid ";
