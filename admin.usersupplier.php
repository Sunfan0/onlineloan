<?php	include "header.php";	?>
				  ...
				  <div class="modal-body text-center"> 
					  <form class="form-horizontal">
						<div class="form-group">
							<label for="SupplierName" class="col-sm-2 control-label">真实姓名</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="SupplierName" readonly>
							</div>
						</div>
						<div class="form-group">
							<label for="SupplierMobile" class="col-sm-2 control-label">手机号</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="SupplierMobile" readonly>
							</div>
						</div>
						<div class="form-group">
							<label for="SupplierType" class="col-sm-2 control-label">用户类型</label>
							<div class="col-sm-10">
	...
	<script type="text/javascript">
		...
		function ShowDetailInfo(id){
			...
			url = "admin.usersupplier.ajax.php?mode=ShowSupplierDetail&id="+id;
...
console.log(json);
				...
				$("#SupplierMobile").val(json.mobile); 
				...
				confirm: function(){
					switch(batch){
						case 0:
							...
							url = "admin.usersupplier.ajax.php?mode=SetBlackList&id="+Settings.CurrentId+"&type="+type+"&reason="+reason;
							$.get(url,function(json,status){
console.log(json);
								switch (json){
									case "1":
						...
						case 1:
							...
							url = "admin.usersupplier.ajax.php?mode=MoreSetBlackList";
							$.get(url,{
...
console.log(json);
		...
		function ResetPassword(batch){//重置密码
			...
			switch(batch){
				case 0:
					strcontent = "您确定重置该供方用户的密码？";
					break;
				case 1:
					strcontent = "您确定重置所有选中的供方用户的密码？";
					break;
			}
			...
			$.confirm({
				...
				confirm: function(){
					switch(batch){
						case 0:
							url = "admin.usersupplier.ajax.php?mode=ResetPsw&id="+Settings.CurrentId;
							$.get(url,function(json,status){
console.log(json);
								switch (json){
									case "1":
					...
					case 1:
							var data = {};
							data.supplierid = SelectData;
							url = "admin.usersupplier.ajax.php?mode=MoreResetPsw";
							$.get(url,{
									data : JSON.stringify(data)
								},function(json,status){
console.log(json);
