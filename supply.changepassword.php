<?php include "supply.header.php";?>
				...
				<div class="panel-body" >
					<form class="form-horizontal">
						<div class="form-group">
							...
							<div class="col-sm-10"><?=$_SESSION["suppliername"]?></div>
						</div>
						<div class="form-group">
	...
	<script type="text/javascript">
		...
		function SaveInfo(){
			...
			if(changePassword2 == ""){$("#changePassword2").focus();CommonWarning('两次输入的新密码不一致。');return;}
			
			$.post("supply.header.php?mode=ChangePassword&oldPassword="+md5($("#currentPassword").val())+"&newPassword="+md5($("#changePassword1").val())
				,function(json){
console.log(json);
				switch(json){
					case "1":
