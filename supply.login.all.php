		...
		<div class="header">
			<div class="header-top">
				...
				<div class='header-top-right'>
					<ul class="ul1">
						<li id="supply.login" class="hoverpointer navBtn">重新登陆</li>
			...
			<div class="panel panel-default" style='width:500px'>
				<div class="panel-heading" style='margin-bottom:30px;'>
					<h3 class="panel-title">
						<span id="Logintitle">供方登录</span>
						<a style="margin-left: 280px;color: #337ab7;" href="demand.login.php">切换到需方登录</a>
					</h3>
				</div>
